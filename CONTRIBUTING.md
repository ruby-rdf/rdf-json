...
* create or respond to an issue for on the [Github Repository](http://github.com/ruby-rdf/rdf-json/issues)
* Fork and clone the repo:
  `git clone git@github.com:your-username/rdf-json.git`
* Install bundle:
  `bundle install`
...
[pr]:      https://github.com/ruby-rdf/rdf-json/compare/
